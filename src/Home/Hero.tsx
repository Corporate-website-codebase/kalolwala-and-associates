...
const Hero = () => {
  ...
  const layers = [
    {
      text: "IGNITE",
      video: "/videos/Ignite_1.mp4",
      align: "left",
      fillIndices: [0, 1, 2],
      href: "/",
      poster: "/images/ignite.webp",
    },
    {
      text: "INNOVATE",
      video: "/videos/Innovate_1.mp4",
      align: "right",
      fillIndices: [4, 5, 6, 7],
      href: "/",
      poster: "/images/innovate.webp",
    },
    {
      text: "IMPACT",
      video: "/videos/Impact_1.mp4",
      align: "left",
      fillIndices: [0, 1, 2],
      href: "/about",
      poster: "/images/impact.webp",
    },
  ];
                ...
                {layer.align === "left" ? (
                  <>
                    <div className="relative z-30 bg-black flex items-center justify-end lg:justify-start w-1/2 lg:w-auto h-[65%]">
                      <h2
                        className="leading-none tracking-tight whitespace-nowrap font-anton notranslate"
                      ...
                      >
                        {layer.text.split("").map((char, i) =>
                          layer.fillIndices.includes(i) ? (
                            ...
                            <span
                              key={i}
                              className="inline-block opacity-0 w-0 h-0 overflow-hidden"
                            >
                              {char}
                            </span>
                          ),
                    ...
                    <div className="relative flex-none w-1/2 lg:flex-1 h-full overflow-hidden">
                      ...
                      >
                        <span
                          aria-hidden="true"
                          className="leading-none tracking-tight whitespace-nowrap font-anton block"
                          style={{ fontSize: getFontSize(), lineHeight: "1" }}
                        >
                          {layer.text.split("").map((char, i) =>
                            !layer.fillIndices.includes(i) ? (
                  ...
                  <>
                    <div className="relative flex-none w-1/2 lg:flex-1 h-full overflow-hidden">
                      ...
                      >
                        <span
                          aria-hidden="true"
                          className="leading-none tracking-tight whitespace-nowrap font-anton text-right block"
                          style={{ fontSize: getFontSize(), lineHeight: "1" }}
                        >
                          {layer.text.split("").map((char, i) =>
                            !layer.fillIndices.includes(i) ? (
                    ...
                    <div className="relative z-30 bg-black flex items-center justify-start lg:justify-end w-1/2 lg:w-auto h-[65%]">
                      <h2
                        className="leading-none tracking-tight whitespace-nowrap font-anton text-right notranslate"
                        style={{ fontSize: getFontSize(), lineHeight: "1" }}
                      >
                        {layer.text.split("").map((char, i) =>
                          layer.fillIndices.includes(i) ? (
