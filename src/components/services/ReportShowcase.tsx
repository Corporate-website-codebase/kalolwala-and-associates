        ...
        <div className="w-full min-h-screen marginal font-noto-sans py-20">
          ...
          {showVideoSelection ? (
            // <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mx-auto mt-10">
             <div className="flex flex-col md:flex-row md:items-center gap-8 mt-10 ">


              <div
                onClick={() => handleSelection("corporate")}
                className="group relative h-auto md:h-[70vh] lg:h-[90vh] overflow-hidden aspect-square cursor-pointer shadow-sm hover:shadow-xl hover:scale-102 duration-300 transition-all"
              >
                <video
                ...
                {/* Overlay matching reference: lighter on hover */}


                {/* Text centered exactly like reference */}
                <div className="absolute inset-0 flex items-center justify-center text-center p-6">
                  <div className="absolute inset-0 bg-[#040d53]/20 group-hover:bg-[#040d53]/10 transition-colors duration-500" />

                  {/* NEW: Radial Gradient specifically behind text */}
                  {/* <div className="absolute inset-0 bg-[radial-gradient(circle_at_center,rgba(0,0,0,0.4)_0%,rgba(0,0,0,0)_35%)] pointer-events-none" /> */}

                  {/* <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-[50%] h-[20%] bg-black/35 blur-3xl rounded-3xl pointer-events-none"></div> */}
                  <h3 className="whitespace-pre-line text-3xl font-semibold text-white leading-tight drop-shadow-xl">
                    Corporate Film
                  </h3>
                  <div className="absolute z-10 bottom-6 right-6 w-12 h-12 bg-white/20 backdrop-blur-md border border-white/30 rounded-full flex items-center justify-center opacity-70 group-hover:opacity-100 group-hover:bg-white/30 transition-all">
              ...
              >
                ...
                {/* Overlay */}
                {/* <div className="absolute inset-0 bg-black/20 group-hover:bg-black/20 transition-all duration-500" /> */}
                {/* NEW: Radial Gradient specifically behind text
                  <div className="absolute inset-0 bg-[radial-gradient(circle_at_center,rgba(0,0,0,0.4)_0%,rgba(0,0,0,0)_35%)] pointer-events-none" />
                   */}

                   {/* <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-[50%] h-[20%] bg-black/40 blur-3xl rounded-3xl pointer-events-none"></div> */}
                   <div className="absolute inset-0 bg-[#490379]/20 group-hover:bg-[#490379]/10 transition-colors duration-500" />
                {/* Text */}
                <div className="absolute inset-0 flex items-center justify-center text-center p-6">
                  <h3 className="whitespace-pre-line text-3xl font-semibold text-white leading-tight drop-shadow-xl">
...
//           {/* HEADER */}
//           <div className="flex flex-col lg:flex-row justify-between items-start md:items-end gap-12 pt-[clamp(40px,8vw,80px)] mb-16">
//             <div className="max-w-5xl">
//               <h1 className="leading-[1.1] mb-6 whitespace-pre-line text-black tracking-tight" style={{ fontSize: "clamp(32px, 4vw, 56px)" }}>
//                 {displayTitle}
//               </h1>
...
//           {/* SELECTION GRID (Video Logic Phase 1) */}
//           {showVideoSelection ? (
//             <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-full mx-auto mt-10">

//               {/* Card 1: Corporate */}
//               <div
//                 onClick={() => handleSelection("corporate")}
//                 className="group relative w-full h-[50vh] md:h-[60vh] overflow-hidden rounded-2xl cursor-pointer shadow-sm hover:shadow-xl"
//               >
//                 <video
...
//                   const Wrapper = isVideoMode ? "div" : Link;
//                   const wrapperProps = isVideoMode
//                     ? { onClick: (e: any) => handleCardClick(card, e) }
//                     : { href: card.link || "#" };
