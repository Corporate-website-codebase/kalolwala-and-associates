    ...
    return (
        ...
        >
            ...
            <div className="w-full flex flex-col lg:flex-row items-stretch relative z-10">
                ...
                >
                    <div className="max-w-3xl xl:max-w-4xl mx-auto w-full" style={{ contain: 'content' }}>
                        ...
                        >
                            ...
                            <div
                                ...
                                style={{ contain: 'layout inline-size', contentVisibility: 'auto', containIntrinsicBlockSize: 'auto 2000px' }}
