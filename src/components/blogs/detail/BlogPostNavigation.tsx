        ...
        <nav aria-label="Article navigation" className="">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                {prevPost ? (
                    ...
                    >
                        <div className="flex items-center gap-2 text-neutral-500 group-hover:text-black transition-colors font-mono text-xs uppercase mb-1">
                            <ArrowLeft size={14} className="transition-transform duration-300 group-hover:-translate-x-1" />
                            <span>Previous Article</span>
                        </div>
                        <h4 className="text-sm font-normal text-neutral-900 group-hover:text-black line-clamp-2 leading-snug transition-colors">
                            {prevPost.title}
                        </h4>
                    </Link>
                ) : (
                ...
                {nextPost && (
                    ...
                    >
                        <div className="flex items-center gap-2 text-neutral-500 group-hover:text-black transition-colors font-mono text-xs uppercase">
                            <span>Next Article</span>
                            <ArrowRight size={14} className="transition-transform duration-300 group-hover:translate-x-1" />
                        </div>
                        <h4 className="text-sm font-medium text-neutral-900 group-hover:text-black line-clamp-2 leading-snug transition-colors">
                            {nextPost.title}
                        </h4>
                    </Link>
                )}
